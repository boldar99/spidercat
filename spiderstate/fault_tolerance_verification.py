...
if __name__ == "__main__":
    ...
    parser.add_argument("--code", type=str, default="42_2_9", help="Code string (default: 17_1_5)")
    parser.add_argument("--state", type=str, default="0", help="State (default: 0)")
    parser.add_argument("--max_col_ops", type=int, default=50, help="Max column operations (default: 100)")
