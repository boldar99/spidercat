...
\toprule
\makecell[l]{QEC Code \\ \& State} & \makecell{CX \\ Count} & \makecell{Flag \\ Count} & \makecell{Reuse \\ Strategy} & \makecell{Sim. \\ Qubits} & Depth & \makecell{Exp. Circ. \\ Volume} & \makecell{Log. Error \\ Rate} & \makecell{Acceptance \\ Rate} \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{7, 1, 3}$ Steane $\ket{\overline{0}}$}} & \multirow{2}{*}{17} & \multirow{2}{*}{4} & Naive & 11 & 5 & 55 & $2.40 \times 10^{-5}$ & 0.9831 \\
 &  &  & Aggressive & 10 & 8 & 81 & $2.49 \times 10^{-5}$ & 0.9833 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{9, 1, 3}$ rot.\@ surface $\ket{\overline{0}}$}} & \multirow{2}{*}{12} & \multirow{2}{*}{2} & Naive & 11 & 5 & 55 & $1.64 \times 10^{-5}$ & 0.9913 \\
 &  &  & Aggressive & 10 & 8 & 80 & $1.69 \times 10^{-5}$ & 0.9913 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{17, 1, 5}$ color code $\ket{\overline{0}}$}} & \multirow{2}{*}{74} & \multirow{2}{*}{21} & Naive & 35 & 12 & 461 & $8.92 \times 10^{-7}$ & 0.9101 \\
 &  &  & Aggressive & 27 & 41 & 1214 & $1.03 \times 10^{-6}$ & 0.9113 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{25, 1, 5}$ rot.\@ surface $\ket{\overline{0}}$}} & \multirow{2}{*}{78} & \multirow{2}{*}{21} & Naive & 46 & 8 & 406 & $6.95 \times 10^{-7}$ & 0.9062 \\
 &  &  & Aggressive & 35 & 41 & 1574 & $7.61 \times 10^{-7}$ & 0.9112 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{20, 2, 6}$ self-dual $\ket{\overline{0}}$}} & \multirow{2}{*}{145} & \multirow{2}{*}{47} & Naive & 57 & 22 & 1557 & $4.84 \times 10^{-8}$ & 0.8051 \\
 &  &  & Aggressive & 48 & 55 & 3261 & $3.83 \times 10^{-8}$ & 0.8094 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{23, 1, 7}$ Golay $\ket{\overline{0}}$}} & \multirow{2}{*}{241} & \multirow{2}{*}{82} & Naive & 83 & 22 & 2727 & $2.67 \times 10^{-7}$ & 0.6696 \\
 &  &  & Aggressive & 64 & 106 & 10035 & $3.21 \times 10^{-7}$ & 0.6760 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{31, 1, 7}$ color code $\ket{\overline{0}}$}} & \multirow{2}{*}{211} & \multirow{2}{*}{69} & Naive & 79 & 23 & 2518 & $1.12 \times 10^{-7}$ & 0.7214 \\
 &  &  & Aggressive & 63 & 90 & 7756 & $1.14 \times 10^{-7}$ & 0.7310 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{49, 1, 7}$ rot.\@ surface $\ket{\overline{0}}$}} & \multirow{2}{*}{240} & \multirow{2}{*}{74} & Naive & 93 & 23 & 3073 & $8.19 \times 10^{-8}$ & 0.6960 \\
 &  &  & Aggressive & 82 & 78 & 9059 & $9.63 \times 10^{-8}$ & 0.7060 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{49, 1, 9}$ color code $\ket{\overline{0}}$}} & \multirow{2}{*}{402} & \multirow{2}{*}{133} & Naive & 133 & 30 & 8263 & $3.73 \times 10^{-8}$ & 0.4828 \\
 &  &  & Aggressive & 111 & 160 & 35142 & $5.74 \times 10^{-8}$ & 0.5054 \\
\midrule
\multirow{2}{*}{\makecell[l]{$\code{47, 1, 11}$ color code $\ket{\overline{0}}$}} & \multirow{2}{*}{955} & \multirow{2}{*}{349} & Naive & 247 & 49 & 121604 & $2.61 \times 10^{-7}$ & 0.0995 \\
 &  &  & Aggressive & 206 & 439 & 828055 & $1.74 \times 10^{-7}$ & 0.1092 \\
\midrule
\bottomrule
\end{tabular}
