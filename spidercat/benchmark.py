...
def benchmark_circuit(circ: stim.Circuit, n, num_samples: int = 100_000, p=0.05, method="spider-cat"):
    ...
    # Process metrics
    stats = process_samples(samples, num_flags, n, -1, p, num_samples, noisy_circ, method)
